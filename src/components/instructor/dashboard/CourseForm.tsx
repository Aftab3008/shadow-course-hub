                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <div className="flex gap-2">
                              ...
                              >
                                <FormControl>
                                  <SelectTrigger className="bg-background border-border hover:border-primary/50 focus:border-primary transition-all duration-200 h-10 sm:h-11 flex-1 focus:ring-2 focus:ring-primary/20">
                  ...
                  <CardContent className="pt-6 relative z-10">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                      ...
                      <div className="flex items-center justify-end flex-col mb-1">
                        <Badge
                          variant="secondary"
                          className="px-3 sm:px-4 py-2 text-xs sm:text-sm bg-green-500/10 text-green-700 dark:text-green-300 border-green-500/20"
                        >
