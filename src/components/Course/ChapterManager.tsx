...
const ChapterManager = ({ chapters, onChaptersUpdate }: ChapterManagerProps) => {
                ...
                <div className="space-y-3">
                  {chapter.lessons.map((lesson) => (
                    <LessonItem
                      ...
                      onLessonsUpdate={(updatedLessons) => updateLessons(chapter.id, updatedLessons)}
        ...
        <VideoUploadDialog 
          ...
          onSave={(lessonData) => {
            ...
            if (targetChapter) {
              ...
              updateLessons(selectedChapterId, [...targetChapter.lessons, newLesson]);
            }
