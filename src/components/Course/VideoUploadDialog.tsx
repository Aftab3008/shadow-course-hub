    ...
    const progressInterval = setInterval(() => {
      setUploadProgress((prev) => {
        if (prev >= 100) {
          ...
          const videoUrl = selectedFile ? URL.createObjectURL(selectedFile) : "";
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <Input
            ...
            placeholder={chapterId ? "Enter lesson title" : "Enter chapter title"}
          ...
          <>
            ...
            <div>
              ...
              <Select 
                ...
                onValueChange={(value) => setFormData({ ...formData, transcodeQuality: value })}
              >
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Higher quality videos take longer to process and require more storage
              </p>
            </div>
          </>
        )}
          ...
          <div className="space-y-2">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm text-foreground">
                {chapterId ? 'Uploading and transcoding video...' : 'Creating chapter...'}
              </span>
            </div>
        ...
        <div className="flex justify-end space-x-2">
          ...
          <Button type="submit" disabled={isUploading}>
            {isUploading ? 'Processing...' : (chapterId ? 'Add Lesson' : 'Add Chapter')}
          </Button>
        </div>
      </form>
    </DialogContent>
