...
import { Star, Clock, Users, Play, CheckCircle, Globe, Award, Download } from "lucide-react";
...
const CourseDetail = () => {
  ...
  const course = {
    ...
    description: "Master React, Redux, Hooks, Context API, and modern development practices with hands-on projects",
    ...
    curriculum: [
      ...
      },
      {
        ...
        duration: "3h 15m",
        lectures: [
          { id: 5, title: "Functional vs Class Components", duration: "25:30", type: "video" },
          { id: 6, title: "Props and PropTypes", duration: "28:45", type: "video" },
          { id: 7, title: "Component Composition", duration: "32:20", type: "video" },
          { id: 8, title: "Exercise: Building a User Card", duration: "45:15", type: "exercise" }
        ]
      },
      {
        id: 3,
        ...
        duration: "4h 20m",
        lectures: [
          { id: 9, title: "Introduction to useState", duration: "30:30", type: "video" },
          { id: 10, title: "useEffect Hook", duration: "35:45", type: "video" },
          { id: 11, title: "Custom Hooks", duration: "40:20", type: "video" },
          { id: 12, title: "Project: Todo List App", duration: "65:15", type: "project" }
        ]
      }
    ]
  };
  ...
  const reviews = [
    ...
    },
    {
      ...
      rating: 5,
      date: "1 month ago",
      comment: "Best React course I've taken. The content is up-to-date and well-structured."
    },
    {
      id: 3,
      user: "Mike Johnson",
      ...
      rating: 4,
      date: "3 weeks ago",
      comment: "Great course content. Would love to see more advanced topics covered."
    }
  ];
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <Link to={`/instructor/${course.instructor.name}`} className="font-semibold text-foreground hover:text-primary">
              ...
              <TabsContent value="curriculum" className="space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-muted-foreground">
                    {course.curriculum.length} sections • {course.curriculum.reduce((acc, section) => acc + section.lectures.length, 0)} lectures • {course.duration}
                  </span>
                </div>
                      ...
                      <AccordionContent>
                        <div className="space-y-2 pt-2">
                          {section.lectures.map((lecture) => (
                            <div key={lecture.id} className="flex items-center justify-between p-3 hover:bg-muted rounded-lg transition-colors">
                              <div className="flex items-center space-x-3">
                                <Play className="h-4 w-4 text-muted-foreground" />
                                <span className="text-foreground">{lecture.title}</span>
                                {lecture.type === 'video' && <Badge variant="outline" className="text-xs">Video</Badge>}
                                {lecture.type === 'exercise' && <Badge variant="outline" className="text-xs">Exercise</Badge>}
                                {lecture.type === 'project' && <Badge variant="outline" className="text-xs">Project</Badge>}
                              </div>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start space-x-4 mb-6">
                      ...
                      <div className="flex-1">
                        <h3 className="text-2xl font-semibold text-foreground mb-2">{course.instructor.name}</h3>
                        <p className="text-muted-foreground mb-4">{course.instructor.bio}</p>
                        
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                          <div className="text-center">
                            <div className="text-2xl font-bold text-foreground">{course.instructor.rating}</div>
                            <div className="text-sm text-muted-foreground">Instructor Rating</div>
                          </div>
                          <div className="text-center">
                            <div className="text-2xl font-bold text-foreground">{course.instructor.students.toLocaleString()}</div>
                            <div className="text-sm text-muted-foreground">Students</div>
                          </div>
                          <div className="text-center">
                            <div className="text-2xl font-bold text-foreground">{course.instructor.courses}</div>
