...
export const courseFormSchema = z.object({
  ...
  category: z.enum(['programming', 'design', 'business', 'marketing', 'photography', 'music'], {
    required_error: "Category is required",
  }),
  level: z.enum(['beginner', 'intermediate', 'advanced'], {
    required_error: "Level is required",
  }),
  price: z.number().min(0, "Price must be positive").max(999.99, "Price must be less than $1000"),
});
